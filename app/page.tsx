      ...
      <div dir="rtl" className="min-h-screen bg-white">
        ...
        <section className="relative py-24 px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              <p className="text-xs font-bold tracking-[0.25em] uppercase text-[#f59e0b] mb-3" style={{ textShadow: '0 2px 8px rgba(255,255,255,0.9)' }}>
                טכנולוגיית גבישים קטליטית
              </p>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#003366] mb-4 leading-tight" style={{ textShadow: '0 2px 12px rgba(255,255,255,0.95)' }}>
                איטום מבנים מורכבים<br />בטכנולוגיה גבישית
              </h2>
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed max-w-2xl mx-auto font-medium" style={{ textShadow: '0 1px 8px rgba(255,255,255,0.9)' }}>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {[
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold tracking-tighter text-[#003366] mb-3" style={{ textShadow: '0 1px 6px rgba(255,255,255,0.9)' }}>
                    {item.title}
                  </h3>
                  <p className="text-slate-700 leading-relaxed font-normal" style={{ textShadow: '0 1px 6px rgba(255,255,255,0.85)' }}>
                    {item.desc}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="py-24 px-6 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#003366] mb-4 leading-tight">
                    ...
                    <ul className="space-y-3 mb-8 text-right" dir="rtl">
                      {solution.applications.map((app, idx) => (
                        <li key={idx} className="flex items-start gap-3 text-sm text-white/80">
                          <svg className="w-5 h-5 text-[#f59e0b] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
        ...
        <section className="relative py-24 px-6 overflow-hidden">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-white mb-4 leading-tight">
